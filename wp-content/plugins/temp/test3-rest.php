...
class My_Rest_Server extends WP_REST_Controller {
  ...
  public function add_post_to_category( $request ){
	...
	'post_web' => $request->get_param('web'),
	'post_hardcap' => $request->get_param('hardcap'),
	'post_token_price' => $request->get_param('token_price'),
	'post_currency' => $request->get_param('currency)',
	'post_whitelist_date' => $request->get_param('whitelist_date'),
	'post_presale_date' => $request->get_param('presale_date'),
	'post_crowdsale_date' => $request->get_param('crowdsale_date'),
        'post_category' => array( $request->get_param( 'category' ) ),
        'post_twitter' => $request->get_param('twitter'),
	'post_telegram' => $request->get_param('telegram'),
	'post_recommended' => $request->get_param('recommended'),
	'post_type' => 'ico'
    );
